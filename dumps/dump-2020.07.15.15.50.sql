...
--
-- Host: localhost    Database: mediatheque_3wa
-- ------------------------------------------------------
...
CREATE TABLE `borrow` (
  ...
  `stockable_media_copy_id` int(11) NOT NULL,
  `return_media_state_id` int(11) DEFAULT NULL,
...
CREATE TABLE `film` (
  ...
  `actors` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `migration_versions` VALUES ('20200715124730','2020-07-15 12:47:42');
...
CREATE TABLE `staff` (
  ...
  `password` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address1` varchar(1024) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `stockable_media_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `stockable_media_id` int(11) NOT NULL,
  `media_state_id` int(11) NOT NULL,
...
CREATE TABLE `stream` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `digital_media_id` int(11) NOT NULL,
  `member_id` int(11) NOT NULL,
...
-- Dump completed on 2020-07-15 15:52:05
